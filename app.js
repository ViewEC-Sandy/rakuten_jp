...
const titles={overview:'營運總覽',platforms:'平台比較',profitability:'收益結構分析',products:'商品跨平台',groups:'專案分析',ads:'樂天廣告分析',productAnalysis:'商品分析',master:'商品主檔',pricing:'定價試算',salesStatus:'銷售狀態',calcParams:'計算參數',import:'資料匯入',history:'匯入紀錄',maintenance:'系統維護'};
...
const MASTER_COLUMNS=[
 ['id','商品番号','base'],['managementNumber','商品管理番号','base'],['nameZh','中文商品名','base'],['projectName','專案名稱','base'],['vendorName','廠商名','base'],['supplyPrice','商品供應價(TWD)','cost'],['barcode','商品條碼','base'],
...
const DEFAULT_MASTER_COLS=['id','managementNumber','nameZh','supplyPrice','Rakuten_price','Rakuten_margin','NETSEA_price','NETSEA_margin','Shopify_price','Shopify_margin','TikTok_price','TikTok_margin'];
